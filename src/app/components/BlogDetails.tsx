      ...
      <div className="bg-gray-50 py-10 w-full sm:w-11/12 lg:w-10/12">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-8 bg-white p-6 shadow-lg rounded">
            {/* Blog Image */}
            <Image
              src="/BlogThumbnail.png" // Path to the image in the public folder
              alt="Blog Thumbnail"
            ...
            <Image
              src="/blog2.png" // Path to the image in the public folder
              alt="Dish"
              width={800} // Adjust width as needed
              height={400} // Adjust height as needed
              className="w-full rounded mb-6"
          ...
          <div className="md:col-span-4 mt-8 md:mt-0">
            ...
            <div className="bg-white p-6 shadow-lg rounded mb-6">
              <Image
                src="/Blogger.png" // Path to the image in the public folder
                alt="Author"
              ...
              <div className="w-full flex justify-center py-2">
                <h1 className="text-[#FF9F0D]">★★★★★</h1>
              </div>
              <div className="flex justify-center space-x-4 mt-2">
                <a href="#" className="text-orange-500 hover:underline">
                  <Image
                    src="/Facebook.png" // Path to the image in the public folder
                    alt="Facebook"
                ...
                <a href="#" className="text-orange-500 hover:underline">
                  <Image
                    src="/Twitter.png" // Path to the image in the public folder
                    alt="Twitter"
                ...
                <a href="#" className="text-orange-500 hover:underline">
                  <Image
                    src="/Instagram.png" // Path to the image in the public folder
                    alt="Instagram"
                    width={24} // Adjust width as needed
                    height={24} // Adjust height as needed
                  />
                ...
                <a href="#" className="text-orange-500 hover:underline">
                  <Image
                    src="/Pinterest.png" // Path to the image in the public folder
                    alt="Pinterest"
                    width={24} // Adjust width as needed
                    height={24} // Adjust height as needed
                  />
            ...
            <div className="p-6 bg-pink-50">
              <div className="mb-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-4">
                    <Image
                      src="https://via.placeholder.com/48" // External image URL
                      alt="Post Thumbnail 1"
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Image
                        src="/FilterbyMenu.png" // Path to the image in the public folder
                        alt="Chicken Fry"
                        width={48} // Adjust width as needed
                        height={48} // Adjust height as needed
                        className="w-12 h-12 rounded-md"
                  ...
                  <li className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Image
                        src="/FilterbyMenu2.png" // Path to the image in the public folder
                        alt="Burger Food"
                        width={48} // Adjust width as needed
                        height={48} // Adjust height as needed
                        className="w-12 h-12 rounded-md"
                  ...
                  <li className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Image
                        src="/FilterbyMenu3.png" // Path to the image in the public folder
                        alt="Pizza"
                        width={48} // Adjust width as needed
                        height={48} // Adjust height as needed
                        className="w-12 h-12 rounded-md"
                  ...
                  <li className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Image
                        src="/FilterbyMenu4.png" // Path to the image in the public folder
                        alt="Fresh Fruits"
                        width={48} // Adjust width as needed
                        height={48} // Adjust height as needed
                        className="w-12 h-12 rounded-md"
                  ...
                  <li className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Image
                        src="/FilterbyMenu5.png" // Path to the image in the public folder
                        alt="Vegetables"
                        width={48} // Adjust width as needed
                        height={48} // Adjust height as needed
                        className="w-12 h-12 rounded-md"
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <Image
                    src="https://via.placeholder.com/100" // External image URL
                    alt="Gallery Image 1"
